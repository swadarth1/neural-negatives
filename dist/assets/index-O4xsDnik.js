	...
	if ( coord.x >= 1.0 ) {
      ...
      <div class="controlPanelBody">
        ...
        <label class="sliderControl">
          ...
          <span class="controlSubheading">use lower values for better performance</span>
        </label>
