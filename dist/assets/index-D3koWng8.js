...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function lp(i,e,t){const n=new Float32Array(Kn),r=new U(0,1,0);return new cn({name:"SphericalGaussianBlur",defines:{n:Kn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:us(),fragmentShader:`
...
`)}const hm={[Ol]:"Linear",[Bl]:"Reinhard",[zl]:"Cineon",[Vl]:"ACESFilmic",[Hl]:"AgX",[kl]:"Neutral",[Gl]:"Custom"};function pm(i,e){const t=hm[e];return t===void 0?(we("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Br=new U;function mm(){ke.getLuminanceCoefficients(Br);const i=Br.x.toFixed(4),e=Br.y.toFixed(4),t=Br.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function xm(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function er(i){return i!==""}function Ml(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Sl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const vm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ka(i){return i.replace(vm,Sm)}const Mm=new Map;function Sm(i,e){let t=Ue[e];if(t===void 0){const n=Mm.get(e);if(n!==void 0)t=Ue[n],we('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ka(t)}const Em=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function El(i){return i.replace(Em,ym)}function ym(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function yl(i){let e=`precision ${i.precision} float;
...
void main() {
    ...
    `,Object.assign(i.style,{position:"fixed",top:"24px",right:"24px",zIndex:"10000",display:"flex",flexDirection:"column",gap:"12px",width:"min(320px, calc(100vw - 48px))",padding:"14px 16px",borderRadius:"16px",color:"white",background:"rgba(0, 0, 0, 0.28)",backdropFilter:"blur(14px) saturate(180%)",WebkitBackdropFilter:"blur(14px) saturate(180%)",boxShadow:"0 8px 30px rgba(0, 0, 0, 0.35)",fontFamily:'"FuturaCyrillicBook", sans-serif',pointerEvents:"auto",visibility:"hidden",opacity:"0",transition:"opacity 0.25s ease"}),document.body.appendChild(i));const e=i.querySelector("#controlPanelToggle"),t=i.querySelector("#panelChevron"),n=i.querySelector(".controlPanelHint"),r=i.querySelector(".controlPanelBody");return e&&Object.assign(e.style,{display:"flex",justifyContent:"space-between",alignItems:"center",width:"100%",padding:"0",border:"0",background:"transparent",color:"inherit",font:"inherit",cursor:"pointer"}),r&&Object.assign(r.style,{display:"grid",gap:"12px"}),n&&Object.assign(n.style,{margin:"0",fontSize:"0.76rem",letterSpacing:"0.04em",textTransform:"uppercase",color:"rgba(255, 255, 255, 0.72)"}),i.querySelectorAll("label").forEach(s=>{Object.assign(s.style,{display:"grid",gap:"6px",fontSize:"0.95rem"})}),i.querySelectorAll(".sliderRow").forEach(s=>{Object.assign(s.style,{display:"grid",gridTemplateColumns:"1fr auto",gap:"12px",alignItems:"center"})}),i.querySelectorAll(".sliderValue").forEach(s=>{Object.assign(s.style,{minWidth:"3ch",textAlign:"right",fontVariantNumeric:"tabular-nums",color:"rgba(255, 255, 255, 0.92)"})}),i.querySelectorAll(".controlSubheading").forEach(s=>{Object.assign(s.style,{fontSize:"0.74rem",lineHeight:"1.35",color:"rgba(255, 255, 255, 0.66)"})}),i.querySelectorAll('input[type="range"]').forEach(s=>{Object.assign(s.style,{width:"100%",margin:"0",accentColor:"rgba(255, 255, 255, 0.92)"})}),i.querySelectorAll("select").forEach(s=>{Object.assign(s.style,{width:"100%",padding:"10px 12px",border:"1px solid rgba(255, 255, 255, 0.2)",borderRadius:"12px",color:"white",background:"rgba(255, 255, 255, 0.1)",boxShadow:"inset 0 0 0 1px rgba(255, 255, 255, 0.06)",backdropFilter:"blur(14px) saturate(180%)",WebkitBackdropFilter:"blur(14px) saturate(180%)",outline:"none",appearance:"none"})}),i.querySelectorAll("option").forEach(s=>{Object.assign(s.style,{color:"#111"})}),{nodeSpreadInput:i.querySelector("#nodeSpread"),nodeSpreadValue:i.querySelector("#nodeSpreadValue"),renderDistanceInput:i.querySelector("#renderDistance"),renderDistanceValue:i.querySelector("#renderDistanceValue"),themeSelect:i.querySelector("#themeSelect"),controlPanel:i,controlPanelToggle:e,panelChevron:t,controlPanelHint:n,controlPanelBody:r}}const{nodeSpreadInput:Za,nodeSpreadValue:Rl,renderDistanceInput:as,renderDistanceValue:ja,themeSelect:zr,controlPanel:os,controlPanelToggle:Sc,panelChevron:hg,controlPanelHint:pg,controlPanelBody:mg}=dg();window.addEventListener("loading-screen-hidden",()=>{os.style.visibility="visible",os.style.opacity="1"});const gg=Og(),en=new Yu(new rc({map:gg,transparent:!0}));en.scale.set(4,1,1);en.visible=!1;let Ja=!1,Zr=null;Gi.add(en);const _g=new Fc(St,document.body);document.addEventListener("click",()=>_g.lock());const Ec=new Audio("/assets/sounds/flip.mp3");Ec.volume=.32;const yc=new Audio("/assets/sounds/flip-reverse.mp3");yc.volume=.32;const ar=document.getElementById("backgroundAudio"),Tc=document.getElementById("muteButton");ar.volume=.1;ar.play().catch(()=>console.log("Autoplay blocked, will start after user interaction"));bc();Tc.addEventListener("click",()=>{ar.muted=!ar.muted,bc()});const _t={forward:!1,backward:!1,left:!1,right:!1,up:!1,down:!1};document.addEventListener("keydown",i=>{i.code==="KeyW"&&(_t.forward=!0),i.code==="KeyS"&&(_t.backward=!0),i.code==="KeyA"&&(_t.left=!0),i.code==="KeyD"&&(_t.right=!0),i.code==="Space"&&(_t.up=!0),i.code==="ShiftLeft"&&(_t.down=!0)});document.addEventListener("keyup",i=>{i.code==="KeyW"&&(_t.forward=!1),i.code==="KeyS"&&(_t.backward=!1),i.code==="KeyA"&&(_t.left=!1),i.code==="KeyD"&&(_t.right=!1),i.code==="Space"&&(_t.up=!1),i.code==="ShiftLeft"&&(_t.down=!1)});function xg(i){const e=12*i,t=new U;St.getWorldDirection(t);const n=new U().crossVectors(t,St.up).normalize();_t.forward&&St.position.addScaledVector(t,e),_t.backward&&St.position.addScaledVector(t,-e),_t.left&&St.position.addScaledVector(n,-e),_t.right&&St.position.addScaledVector(n,e),_t.up&&(St.position.y+=e),_t.down&&(St.position.y-=e)}function bc(){Tc.textContent=ar.muted?"🔇":"🔊"}const Mt={photosRevealed:0,cities:new Set,countries:new Set,totalDistance:0,lastLat:null,lastLon:null},Qa={},eo={};function vg(){document.getElementById("statPhotos").innerText=Mt.photosRevealed,document.getElementById("statCities").innerText=Mt.cities.size,document.getElementById("statCountries").innerText=Mt.countries.size,document.getElementById("statDistance").innerText=Math.round(Mt.totalDistance).toLocaleString()}function Vr(i){const e=document.getElementById(i);e.classList.add("statPulse"),setTimeout(()=>{e.classList.remove("statPulse")},400)}function Mg(){const i=document.getElementById("cityList"),e=document.getElementById("countryList"),t=Object.entries(Qa).sort((r,s)=>s[1]-r[1]).map(([r,s])=>`${r}`).join(", "),n=Object.entries(eo).sort((r,s)=>s[1]-r[1]).map(([r,s])=>{const a=Rc(r),o=new Intl.DisplayNames(["en"],{type:"region"}).of(r);return`${a} ${o}`}).join(", ");i.textContent=t,e.textContent=n}const jn=[];class go{constructor(e,t=null){this.position=e.clone(),this.parent=t,this.direction=new U,this.count=0}}const xn=[],Sg=new go(new U(0,0,0));xn.push(Sg);const Eg=7500,yg=50,Tg=1.5,bg=.9;let wi=Number(Za.value),sn=42,yi=!1,Ui=[],Gr=null;Ac($a[1].value);wg();const Ag=new hf,Ni=[];function Ac(i){Gi.background=new Xe(i),document.body.style.backgroundColor=i}function wg(){Cl(!1),$a.forEach(i=>{const e=document.createElement("option");e.value=i.value,e.textContent=i.label,zr.appendChild(e)}),zr.value=$a[1].value,Rl.textContent=wi.toFixed(2),ja.textContent=String(sn),Sc.addEventListener("click",()=>{Cl(os.classList.contains("is-collapsed"))}),Za.addEventListener("input",()=>{wi=Number(Za.value),Rl.textContent=wi.toFixed(2),Ig()}),as.addEventListener("input",()=>{sn=Number(as.value),ja.textContent=String(sn)}),zr.addEventListener("change",()=>{Ac(zr.value)})}function Cl(i){os.classList.toggle("is-collapsed",!i),Sc.setAttribute("aria-expanded",String(i)),hg.textContent=i?"▾":"▸",pg.style.display=i?"none":"block",mg.style.display=i?"grid":"none"}function Rg(){const i=Math.max(1,Ui.length);sn=Math.min(sn,i),as.max=String(i),as.value=String(sn),ja.textContent=String(sn)}function Cg(){yi=!1,jn.length=0,xn.length=0,xn.push(new go(new U(0,0,0)))}function Pg(){jn.length=0,Ui.forEach(i=>{const e=new U((Math.random()-.5)*80*wi,(Math.random()-.5)*40*wi,(Math.random()-.5)*80*wi);i.attractor=e,jn.push(e)})}function Lg(){Ni.forEach(i=>{Gi.remove(i.group)}),Ni.length=0}function Dg(i){const e=i.width/i.height,t=new Ei,n=new Ei;t.add(n);const r=3.6,s=.5,a=r*e,o=new Gt(new Jn(a,r),new tr({color:16777215}));o.position.y=-s/2,n.add(o);const c=r-s-.2,l=c*e,f=new Gt(new Jn(l,c),new tr({map:i.texture,transparent:!0,opacity:0}));f.position.set(0,(s+.2)/2-.5,.01),n.add(f);const h=new Gt(new Jn(l,c),new tr({map:i.backTexture}));h.position.copy(f.position),h.rotation.y=Math.PI,n.add(h),t.position.copy(i.attractor),n.rotation.z=i.rotationZ??(Math.random()-.5)*.2,i.flipped&&(n.rotation.y=Math.PI);const u={group:t,pivot:n,front:f,back:h,flipped:!!i.flipped,opacity:0,targetOpacity:0,distance:1/0,data:i,discovered:!!i.discovered};Ni.push(u),Gi.add(t)}function wc(){Ui.length&&(Lg(),Cg(),Pg(),Ui.forEach(Dg),Fi.setDrawRange(0,2),Fi.attributes.position.needsUpdate=!0,en.visible=!1,Ja=!1,Zr=null)}function Ig(){Ui.length&&(Gr!==null&&window.cancelAnimationFrame(Gr),Gr=window.requestAnimationFrame(()=>{Gr=null,wc()}))}async function Ug(){const i=await Hc();Ui=i,document.getElementById("statTotalPhotos").innerText=i.length,sn=Math.min(sn,Math.max(1,i.length)),Rg();const e=await Promise.all(i.map(t=>new Promise(n=>{Ag.load(`/assets/photos/${t.filename}`,r=>{cr.initTexture(r),kc(),n(r)})})));i.forEach((t,n)=>{t.texture=e[n],t.backTexture=Fg(t,t.width/t.height),t.discovered=!!t.discovered,t.flipped=!!t.flipped,t.rotationZ=t.rotationZ??(Math.random()-.5)*.2}),wc()}document.addEventListener("keydown",i=>{if(i.code!=="KeyE")return;const e=5;let t=null,n=1/0;const r=St.position.clone(),s=new U;if(St.getWorldDirection(s),Ni.forEach(a=>{const o=a.group.position.clone(),c=r.distanceTo(o);if(c<e){const l=o.clone().sub(r).normalize();s.angleTo(l)<Math.PI/4&&c<n&&(t=a,n=c)}}),t){if(t.flipped=!t.flipped,t.data.flipped=t.flipped,t.flipped&&!t.discovered){t.discovered=!0;const o=t.data;o.discovered=!0,Mt.photosRevealed++,Vr("statPhotos");const c=o.city||o.town||o.village||o.hamlet||o.state;if(c){const l=Mt.cities.size;Mt.cities.add(c),Mt.cities.size>l&&(Vr("statCities"),Qa[c]=(Qa[c]||0)+1)}if(o.countryCode){const l=kg(o.countryCode),f=Mt.countries.size;Mt.countries.add(l),Mt.countries.size>f&&Vr("statCountries"),eo[o.countryCode]=(eo[o.countryCode]||0)+1}if(Mt.lastLat!==null&&o.lat!==null&&o.lon!==null){const l=Wg(Mt.lastLat,Mt.lastLon,o.lat,o.lon);Mt.totalDistance+=l,Vr("statDistance")}Mt.lastLat=o.lat,Mt.lastLon=o.lon,Mg(),vg()}const a=t.flipped?Ec:yc;a.currentTime=0,a.play(),new Js.Tween(t.pivot.rotation).to({y:t.flipped?Math.random()>.5?Math.PI:-Math.PI:0,z:t.flipped?(Math.random()-.5)*.25:0},450).easing(Js.Easing.Quadratic.Out).start()}});function Ng(i,e,t,n,r,s){const a=e.split(" ");let o="",c=[];for(let l=0;l<a.length;l++){const f=o+a[l]+" ";i.measureText(f).width>r&&l>0?(c.push(o.trim()),o=a[l]+" "):o=f}return c.push(o.trim()),c.forEach((l,f)=>{i.strokeText(l,t,n+f*s),i.fillText(l,t,n+f*s)}),c.length*s}function Fg(i,e){const n=document.createElement("canvas");n.width=1024*e,n.height=1024;const r=n.getContext("2d");r.fillStyle="#ffffff",r.fillRect(0,0,n.width,n.height);const s=n.height/512,a="#00000a";r.globalAlpha=.95+Math.random()*.05,r.fillStyle=a,r.strokeStyle=a,r.lineWidth=4*s,r.textAlign="left",r.textBaseline="top",r.font=`${72*s}px "Sid_handwriting"`;const o=new Date(i.date),c=String(o.getDate()).padStart(2,"0"),l=String(o.getMonth()+1).padStart(2,"0"),f=o.getFullYear(),h=`${c} . ${l} . ${f}`;let u=o.getHours();const m=String(o.getMinutes()).padStart(2,"0"),_=u>=12?"pm":"am";u=u%12,u===0&&(u=12);const M=`${u}:${m}${_}`;i.lat!=null&&i.lat.toFixed(4),i.lon!=null&&i.lon.toFixed(4);const p=Rc(i.countryCode);let d=i.city||i.town||i.village||i.hamlet||i.state||"Unknown";e<1&&d.length>9&&(d=d.slice(0,9)+"...");const b=[`${d} ${p}`,h,M];let T=40*s;const P=40*s,A=n.width-80*s,L=80*s;b.forEach(y=>{const Y=Ng(r,y,P,T,A,L);T+=Y+20*s});const x=new uc(n);return x.minFilter=xt,x.magFilter=xt,x.anisotropy=4,x.needsUpdate=!0,x.flipY=!0,x}function Og(){const e=document.createElement("canvas");e.width=1024*4,e.height=256*4;const t=e.getContext("2d");t.scale(4,4),t.fillStyle="rgba(0,0,0,0.65)",t.beginPath(),t.roundRect(0,0,1024,256,20),t.fill(),t.font='72px "FuturaCyrillicBook"',t.fillStyle="white",t.textAlign="center",t.textBaseline="middle",t.fillText("Press E to interact",512,128);const n=new uc(e);return n.anisotropy=4,n}const to=new lc({color:65535,transparent:!0,opacity:.7}),Bg=2e4,qn=new Float32Array(Bg*6),Fi=new Ht;Fi.setAttribute("position",new Vt(qn,3));const zg=new ef(Fi,to);Gi.add(zg);let Hr=0;function Vg(){if(xn.length>Eg){yi=!0,console.warn("Tree stopped: node cap reached");return}if(jn.length===0){yi=!0,console.log("Tree finished (all attractors consumed)");return}if(yi){console.log("Tree finished");return}let i=0;xn.forEach(t=>{t.direction.set(0,0,0),t.count=0});for(let t=jn.length-1;t>=0;t--){const n=jn[t];let r=null,s=1/0;if(xn.forEach(a=>{const o=a.position.distanceTo(n);if(o<Tg){jn.splice(t,1),r=null;return}o<yg&&o<s&&(r=a,s=o)}),r){const a=new U().subVectors(n,r.position).normalize();r.direction.add(a),r.count++}}const e=[];xn.forEach(t=>{if(t.count>0){const n=t.direction.divideScalar(t.count).normalize(),r=t.position.clone().add(n.multiplyScalar(bg)),s=new go(r,t);e.push(s)}}),xn.push(...e),i=e.length,i===0&&(yi=!0,console.log("Tree growth finished!"))}function Gg(){Hr=0,xn.forEach(i=>{if(!i.parent)return;const e=i.position,t=i.parent.position,n=Hr*6;qn[n]=e.x,qn[n+1]=e.y,qn[n+2]=e.z,qn[n+3]=t.x,qn[n+4]=t.y,qn[n+5]=t.z,Hr++}),Fi.setDrawRange(0,Math.max(Hr*2,2)),Fi.attributes.position.needsUpdate=!0}function Hg(){const i=Date.now()*.002;to.color.setHSL(.5,1,.5+.5*Math.sin(i)),to.opacity=.5+.5*Math.sin(i)}function Rc(i){return i?i.toUpperCase().split("").map(e=>String.fromCodePoint(127397+e.charCodeAt())).join(""):""}function kg(i){if(!i)return"Unknown";try{return new Intl.DisplayNames(["en"],{type:"region"}).of(i)}catch{return i}}function Wg(i,e,t,n){const s=f=>f*Math.PI/180,a=s(t-i),o=s(n-e),c=Math.sin(a/2)*Math.sin(a/2)+Math.cos(s(i))*Math.cos(s(t))*Math.sin(o/2)*Math.sin(o/2);return 6371*(2*Math.atan2(Math.sqrt(c),Math.sqrt(1-c)))}const kr=new U,js=new U,Pl=new U;function _o(){requestAnimationFrame(_o);const i=fg.getDelta();xg(i),yi||(Vg(),Gg()),Hg();const e=performance.now();Pl.copy(St.position);const t=Ni.map(s=>(s.group.getWorldPosition(kr),{p:s,dist:kr.distanceToSquared(Pl)})).sort((s,a)=>s.dist-a.dist);t.forEach((s,a)=>{s.p.targetOpacity=a<sn?1:0});const n=5,r=n*n;if(!Ja&&t.length>0){const s=t[0];s.dist<r&&(en.position.copy(s.p.group.position),en.position.y+=2.5,en.visible=!0,Zr=s.p,Ja=!0,setTimeout(()=>{en.visible=!1},4e3))}en.visible&&Zr&&(en.position.y=Zr.group.position.y+2.5+Math.sin(e*.003)*.1),Ni.forEach(s=>{s.group.getWorldPosition(kr),js.copy(St.position),js.y=kr.y,s.group.lookAt(js);const a=i*2;s.opacity+=(s.targetOpacity-s.opacity)*a,s.front.material.opacity=s.opacity;const o=s.opacity>.01;s.front.visible=o,s.back.visible=o}),Js.update(),cr.render(Gi,St)}async function Xg(){await document.fonts.load('72px "FuturaCyrillicBook"'),await document.fonts.load('72px "Sid_handwriting"'),await Ug(),_o()}Xg().catch(i=>{console.error("Failed to initialize the scene:",i),_o()});window.addEventListener("resize",()=>{St.aspect=window.innerWidth/window.innerHeight,St.updateProjectionMatrix(),cr.setSize(window.innerWidth,window.innerHeight)});
